...
const ROLE_LABEL: Record<StaffInvitation['role'], string> = { owner: 'Propietario', admin: 'Administrador', operator: 'Operador' };
...
export function InvitationsSection({ canInviteOwner }: { canInviteOwner: boolean }) {
  ...
  const [role, setRole] = useState<'admin' | 'operator' | 'owner'>('operator');
