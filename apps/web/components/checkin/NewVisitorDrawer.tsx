...
export function NewVisitorDrawer({ open, activities, onClose, onDone }: NewVisitorDrawerProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 outline-none" role="dialog" aria-modal="true" aria-labelledby={titleId}>
      ...
      <div className={cn('drawer-panel absolute inset-x-0 bottom-0 max-h-[92dvh] rounded-t-2xl border-t border-line bg-surface shadow-xl', 'md:inset-y-0 md:right-0 md:left-auto md:h-dvh md:w-full md:max-w-md md:rounded-none md:border-l md:border-t-0', 'flex flex-col')}>
